...
public class JwtService {
    ...
    public String extractUsername(String token) {
        return extractClaims(token, Claims::getSubject); // this will be extracting the username aka our email
    }
    ...
    public String generateToken(
        ...
        return Jwts
                ...
                .setSubject(userDetails.getUsername()) // we mean email not username D:
